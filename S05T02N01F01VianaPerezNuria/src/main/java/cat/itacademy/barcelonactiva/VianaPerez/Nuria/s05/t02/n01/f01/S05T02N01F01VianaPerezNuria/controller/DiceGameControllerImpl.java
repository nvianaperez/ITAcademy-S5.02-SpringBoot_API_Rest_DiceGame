...
import cat.itacademy.barcelonactiva.VianaPerez.Nuria.s05.t02.n01.f01.S05T02N01F01VianaPerezNuria.model.service.IDiceGameService;
...
public class DiceGameControllerImpl implements IDiceGameController {
    ...
    public ResponseEntity<?> updatePlayer(@PathVariable Long playerId, @RequestBody PlayerDTO playerDTO, WebRequest request) {
        try {
    ...
    public ResponseEntity<?> playGame(@PathVariable Long playerId, WebRequest request) {
        try {
    ...
    public ResponseEntity<Message> deleteAllGames(@PathVariable Long playerId, WebRequest request) {
        try {
    ...
    public ResponseEntity<?> getAllGamesByPlayer(@PathVariable Long playerId, WebRequest request) {
        try {
